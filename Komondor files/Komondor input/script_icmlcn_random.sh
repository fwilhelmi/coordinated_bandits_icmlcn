...
cd input/input_ICMLCN2025/input_9bss_fullbuffer_dstamax_3
ls
...
do 
	...
	./komondor_main ../input/input_ICMLCN2025/input_9bss_fullbuffer_dstamax_3/${array_nodes[executing_ix_nodes]} ../input/input_ICMLCN2025/agents_free_coordinated_ts_9bss.csv ../output/script_output.txt sim_${executing_ix_nodes} 0 0 0 1 1 $SIM_TIME $SEED >> ../output/logs_console.txt
done
cd ..